...
void init_style_btn_toggle_MAIN_FOCUSED(lv_style_t *style) {
...
lv_style_t *get_style_btn_toggle_MAIN_FOCUSED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_btn_toggle_MAIN_FOCUSED(style);
    }
    return style;
};
...
void add_style_btn_toggle(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_btn_toggle_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
...
void remove_style_btn_toggle(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_btn_toggle_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
...
void init_style_main_item_MAIN_FOCUSED(lv_style_t *style) {
    lv_style_set_border_color(style, lv_color_hex(0xff0000));
    lv_style_set_border_opa(style, 255);
    lv_style_set_border_width(style, 2);
    lv_style_set_border_side(style, LV_BORDER_SIDE_FULL);
...
lv_style_t *get_style_main_item_MAIN_FOCUSED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_main_item_MAIN_FOCUSED(style);
    }
    return style;
};
...
void add_style_main_item(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_main_item_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
...
void remove_style_main_item(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_main_item_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
...
void init_style_btn_default_MAIN_FOCUSED(lv_style_t *style) {
    lv_style_set_border_color(style, lv_color_hex(0xff0000));
    lv_style_set_border_opa(style, 255);
    lv_style_set_border_width(style, 2);
    lv_style_set_border_side(style, LV_BORDER_SIDE_FULL);
...
lv_style_t *get_style_btn_default_MAIN_FOCUSED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_btn_default_MAIN_FOCUSED(style);
    }
    return style;
};
...
void add_style_btn_default(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_btn_default_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
...
void remove_style_btn_default(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_btn_default_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
